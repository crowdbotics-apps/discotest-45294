"""
Django settings for discotest_45294 project.
...
ROOT_URLCONF = 'discotest_45294.urls'
...
WSGI_APPLICATION = 'discotest_45294.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "discotest_45294 API",
    "DESCRIPTION": "API documentation for discotest_45294 App",
    "VERSION": "v1",
}
